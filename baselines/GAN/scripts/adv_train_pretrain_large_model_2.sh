...
python src/run_s2s_adv_train.py \
    ...
    --d_epoch 1 \
    --d_step 6 \
    --pretrain_save_path /home/tuq59834/code/project/Tk-ins/Tk-Instruct/teacher_model/pretrain_classifier_bert-base-cased_add-def \
    --multinomial \
    --force_pretrain \
    --pretrain_D_path bert-base-cased \
...
python src/run_s2s_adv_train.py \
    ...
    --d_epoch 1 \
    --d_step 6 \
    --pretrain_save_path /home/tuq59834/code/project/Tk-ins/Tk-Instruct/teacher_model/pretrain_classifier_bert-base-cased \
    --multinomial \
    --force_pretrain \
    --pretrain_D_path bert-base-cased \
    --pretrain_G_path /home/tuq59834/code/project/Tk-ins/Tk-Instruct/teacher_model/POS_augmentation-num_0
...
python src/run_s2s_adv_train.py \
    ...
    --d_epoch 1 \
    --d_step 6 \
    --pretrain_save_path /home/tuq59834/code/project/Tk-ins/Tk-Instruct/teacher_model/pretrain_classifier_bert-large-cased_add-def \
    --multinomial \
    --force_pretrain \
