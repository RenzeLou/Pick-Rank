...
export EXP="beam_${beam}-epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}-loss_mix_ratio_pos_${loss_mix_ratio_pos}-margin_pos_${margin_pos}"
...
# export EXP="epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}-loss_mix_ratio_pos_${loss_mix_ratio_pos}-margin_pos_${margin_pos}_forbiden"
# echo "experiment name: $EXP"
