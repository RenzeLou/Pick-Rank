...
export out_dir="output_pointer-null_ori"
...
export loss_mix_ratio_pos=$loss_mix_ratio_pos  ## fix the ratio to 1, just tune the margin
...
# export EXP="sample_num_${sample_num_pos}-seq_len_${seq_len}-last_sen_num_${last_sen_num}-sample_times_${sample_times}-margin_pos_${margin_pos}-loss_mix_ratio_pos_${loss_mix_ratio_pos}"
export EXP="margin_pos_${margin_pos}-loss_mix_ratio_pos_${loss_mix_ratio_pos}"
