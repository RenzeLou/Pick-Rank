...
batch2=$3
train_epochs=$4
pointer_train_epoch=$5
loss_mix_ratio_null=$6
margin_null=$7
...
export EXP="epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}--loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}_forbiden"
...
export EXP="ori_anchor_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}--loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}_forbiden"
echo "experiment name: $EXP"
