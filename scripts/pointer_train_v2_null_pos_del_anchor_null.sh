...
loss_mix_ratio_null=1
margin_null=$5
loss_mix_ratio_pos=1
margin_pos=$6
loss_mix_ratio_neg=1
margin_neg=$7
...
export neg_loss_type="contrastive_loss_max_v6"
export train_epochs=$train_epochs
export pointer_train_epoch=$pointer_train_epoch
export margin_null=$margin_null
export loss_mix_ratio_null=$loss_mix_ratio_null  
export loss_mix_ratio_pos=$loss_mix_ratio_pos
export margin_pos=$margin_pos
export loss_mix_ratio_neg=$loss_mix_ratio_neg
...
export EXP="nullan_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}-loss_mix_ratio_pos_${loss_mix_ratio_pos}-margin_pos_${margin_pos}_loss_mix_ratio_neg_${loss_mix_ratio_neg}-margin_neg_${margin_neg}-loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}"
...
export EXP="nullan_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}-loss_mix_ratio_pos_${loss_mix_ratio_pos}-margin_pos_${margin_pos}_loss_mix_ratio_neg_${loss_mix_ratio_neg}-margin_neg_${margin_neg}-loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}_forbiden"
echo "experiment name: $EXP"
...
# export EXP="ori_anchor_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}--loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}"
# echo "experiment name: $EXP"
...
# export EXP="loss_changed-forbiden_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}-loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}"
# echo "experiment name: $EXP"
