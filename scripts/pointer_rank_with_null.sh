...
export loss_mix_ratio_neg=1  ## fix the ratio to 1, just tune the margin

export pooling="mean"
export lr_encoder=5e-6
export lr_proj=3e-4

export EXP="null_sample_num_${sample_num_pos}-seq_len_${seq_len}-last_sen_num_${last_sen_num}-sample_times_${sample_times}-margin_null_${margin_null}-loss_mix_ratio_null_${loss_mix_ratio_null}"
