...
export sample_num="1"
export EXP="more-neg_sample-${sample_num}-all-neg-cal-0.01"
...
export sample_num="1"
export EXP="more-neg_sample-${sample_num}-all-neg-cal-0.05"
echo "experiment name: $EXP"
...
export sample_num="1"
export EXP="more-neg_sample-${sample_num}-all-neg-cal-0.1"
echo "experiment name: $EXP"
...
export sample_num="1"
export EXP="more-neg_sample-${sample_num}-all-neg-cal-0.5"
echo "experiment name: $EXP"
