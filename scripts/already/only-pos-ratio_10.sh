...
export EXP="Only-POS-margin_pos_${margin_pos}-mix_ratio_${loss_mix_ratio}-num_${sample_num_pos}"
echo "experiment name: $EXP"

deepspeed --master_port $port  src/run_s2s_test_pos.py \
    --do_predict \
    --predict_with_generate \
    --model_name_or_path /home/tuq59834/code/project/Tk-ins/Tk-Instruct/output/Only-POS-margin_pos_0.01-mix_ratio_10-num_2 \
