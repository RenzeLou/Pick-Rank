...
export sample_times=$sample_times
export seed=$seed
...
export EXP="epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}--loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}_lr_${learning_rate}_sample_num_pos_${sample_num_pos}_seq_len_${seq_len}_sample_times_${sample_times}_seed_${seed}"
