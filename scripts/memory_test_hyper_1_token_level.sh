...
export EXP="token_level_memo_proj-att-proj_${projector_dim}-${pooling}"
echo "experiment name: $EXP"

deepspeed --master_port $port  src/run_s2s_memory_test_token_level.py \
    --do_train \
    --do_predict \
...
export projector_dim=256
export EXP="token_level_memo_proj-att-proj_${projector_dim}-${pooling}-reverse"
echo "experiment name: $EXP"
...
# export projector_dim=64
# export EXP="memo_proj-att-proj_${projector_dim}-${pooling}"
# echo "experiment name: $EXP"

# deepspeed --master_port $port  src/run_s2s_memory_test.py \
#     --do_train \
#     --do_predict \
#     --predict_with_generate \
#     --model_name_or_path $model \
...
# export projector_dim=64
# export EXP="memo_proj-att-proj_${projector_dim}-${pooling}-reverse"
# echo "experiment name: $EXP"
