...
loss_mix_ratio_null=$5
margin_null=$6
# sample_times=$7

export sample_num_pos=7
export seq_len=2048
...
export out_dir="output_pointer_first_train-v2"
...
export sample_times=3
export EXP="epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}--loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}-sample_times_${sample_times}-sample_num_pos_${sample_num_pos}-seq_len_${seq_len}"
