...
export EXP="baseline_seq_len_512"
echo "experiment name: $EXP"

python src/run_s2s_output_constrain.py \
    --do_train \
    --do_predict \
...
export loss_mix_ratio_null="0.003"
export margin_null="0.03"
export EXP="ratio_${loss_mix_ratio_null}-margin_${margin_null}_seq_len_512"
echo "experiment name: $EXP"
