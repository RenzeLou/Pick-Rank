...
export out_dir="output_pointer_first_train-rank_null-fix_bug_in_pooling"
...
# export EXP="forbiden_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}-loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}"
# echo "experiment name: $EXP"
