...
export out_dir="output_pointer_compare_rep_ori"
...
export EXP="on_ori_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}--loss_mix_ratio_pos_${loss_mix_ratio_pos}-margin_pos_${margin_pos}"
