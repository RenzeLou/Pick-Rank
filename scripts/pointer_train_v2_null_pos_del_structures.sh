...
export EXP="Stu_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}-loss_mix_ratio_pos_${loss_mix_ratio_pos}-margin_pos_${margin_pos}_loss_mix_ratio_neg_${loss_mix_ratio_neg}-margin_neg_${margin_neg}-loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}"
...
export EXP="Stu_epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}-loss_mix_ratio_pos_${loss_mix_ratio_pos}-margin_pos_${margin_pos}_loss_mix_ratio_neg_${loss_mix_ratio_neg}-margin_neg_${margin_neg}-loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}_forbiden"
echo "experiment name: $EXP"
