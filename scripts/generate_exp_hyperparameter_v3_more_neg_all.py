...
for num in sample_num_list:
    shell_name = "{}-search_num_{}_more_neg_all".format(model_name,num)
...
'''
    ...
    if neg_loss_only:
        t1 = 'export EXP="more-neg_sample-${sample_num}_neg_loss_only-all-neg-cal"'
    else:
        t1 = 'export EXP="more-neg_sample-${sample_num}-all-neg-cal"'
