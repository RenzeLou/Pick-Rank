...
export EXP="only_null-memo_proj-${pooling}"
...
deepspeed --master_port $port  src/run_s2s_memory_test.py \
    ...
    --per_device_train_batch_size $batch_2 \
    --per_device_eval_batch_size $batch_2 \
...
# export EXP="only_null-memo_proj-${pooling}-reverse"
# echo "experiment name: $EXP"
...
# export EXP="only_null-${pooling}-reverse"
# echo "experiment name: $EXP"
