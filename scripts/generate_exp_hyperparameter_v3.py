...
for num in sample_num_list:
    shell_name = "{}-search_num_{}".format(model_name,num)
...
'''
    ...
    t = 'export sample_num="{}"'
    same = '''
export EXP="${model}-sample-${sample_num}-ratio_fixed-${loss_mix_ratio}-margin_fixed-${margin}"
