...
export out_dir="output_repeat_tune_on_null"
...
export EXP="ratio_${loss_mix_ratio_neg}-margin_${margin_neg}-strategy_${strategy}-sample_num_${sample_num_pos}"
