...
margin_pos_list = [0.01] # 0.0001,0.001,0.1
margin_neg_list = [0.001]
sample_num_pos = [2]
sample_num_neg = [0]
pos_neg_ratio_list = [0]
...
'''
    ...
    same = '''
export EXP="Only-POS-margin_pos_${margin_pos}-mix_ratio_${loss_mix_ratio}-num_${sample_num_pos}-lr_${learning_rate}"
