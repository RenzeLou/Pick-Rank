...
export EXP="pointer-lr_${lr_proj}-encoder-lr_${lr_encoder}-sample_num_${sample_num_pos}-margin_pos_${margin_pos}-loss_mix_ratio_pos_${loss_mix_ratio_pos}"
...
export EXP="pointer-lr_${lr_proj}_hidden_${pointer_hidden_dim}-encoder-lr_${lr_encoder}-sample_num_${sample_num_pos}-margin_pos_${margin_pos}-loss_mix_ratio_pos_${loss_mix_ratio_pos}"
echo "experiment name: $EXP"
