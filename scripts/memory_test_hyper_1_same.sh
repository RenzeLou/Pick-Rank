...
export EXP="same_memo_proj-att-proj_${projector_dim}-${pooling}-epoch_1"
echo "experiment name: $EXP"

deepspeed --master_port $port  src/run_s2s_memory_test_2.py \
    --do_train \
    --do_predict \
...
export projector_dim=256
export EXP="same_memo_proj-att-proj_${projector_dim}-${pooling}"
echo "experiment name: $EXP"
