...
loss_mix_ratio_list = [10]  # 0.1,0.3,0.6
...
# neg_loss_only = False  
pos_neg_ratio_list = [0.5] # 0,0.5,1
...
for ratio in loss_mix_ratio_list:
    shell_name = "new_add_mixed_ratio-{}".format(ratio)
...
'''
    ...
    template = template.format(model_name,margin_pos_list[0],margin_neg_list[0],sample_num_list[0],pos_neg_ratio_list[0],ratio)
