...
export EXP="pointer_hidden_dim_${pointer_hidden_dim}-act_func_${act_func}-sample_num_${sample_num_pos}-margin_pos_${margin_pos}-loss_mix_ratio_pos_${loss_mix_ratio_pos}-seq_${seq_len}"
...
export EXP="pointer_hidden_dim_None-sample_num_${sample_num_pos}-margin_pos_${margin_pos}-loss_mix_ratio_pos_${loss_mix_ratio_pos}-seq_${seq_len}"
echo "experiment name: $EXP"
