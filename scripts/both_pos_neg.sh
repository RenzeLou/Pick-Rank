...
export EXP="Both-POS-NEG-margin_pos_${margin_pos}-margin_neg_${margin_neg}-mix_ratio_${loss_mix_ratio}-pos_num_${sample_num_pos}-neg_num_${sample_num_neg}-pos_neg_ratio_${pos_neg_ratio}"
