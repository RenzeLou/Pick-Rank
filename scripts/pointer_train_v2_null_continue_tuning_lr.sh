...
export EXP="epochs_${train_epochs}-pointer_epochs_${pointer_train_epoch}--loss_mix_ratio_null_${loss_mix_ratio_null}-margin_null_${margin_null}_lr_${learning_rate}"
