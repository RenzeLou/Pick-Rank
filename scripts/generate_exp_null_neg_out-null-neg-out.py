...
loss_mix_ratio_neg_list = [0.0001]  # TODO: need to be decided  ,0.001,0.003,0.01,0.03,0.1,0.3
margin_neg_list = [0.0001] # ,0.001,0.01,0.006,0.003,0.03,0.06

loss_mix_ratio_out_list = [0.2,0.4,0.6,0.8,1]
margin_out_list = [0.001,0.003,0.01,0.03,0.1,0.3]

sample_num_pos = [1]
sample_num_neg = [1]
# pos_neg_ratio_list = [1]
lr_list = [5e-05] 
out_dir = "output_null_neg_out"
neg_out_sample_num = 2
...
for ratio in loss_mix_ratio_out_list:
    shell_name = "out-ratio_{}".format(ratio)
# for lr in lr_list:
...
'''
    ...
    template = template.format(model_name,sample_num_pos[0],sample_num_neg[0],loss_mix_ratio_null_list[0],
                               loss_mix_ratio_neg_list[0],ratio,margin_null_list[0],margin_neg_list[0],
                               lr_list[0],out_dir,neg_out_sample_num)
