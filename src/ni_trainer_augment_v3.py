...
class NITrainer(Seq2SeqTrainer):
    ...
    def init_hyper(self,loss_mix_ratio:float=None,margin:float=None,neg_loss_only:bool=False,neg_loss_type:str="contrastive_loss_all"):
        self.loss_mix_ratio = loss_mix_ratio if loss_mix_ratio is not None else 0.0
