...
from ni_collator_augment_v3_pos import DataCollatorForNI
# from ni_trainer_augment_v2 import NITrainer, DenserEvalCallback
from ni_trainer_augment_v3_pos import NITrainer, DenserEvalCallback
...
from modeling_t5_mod_pos import T5ForConditionalGeneration_neg
...
class NITrainingArguments(Seq2SeqTrainingArguments):
    ...
    null_def_cons: bool = field(
        default=False, metadata={"help": "If true, use the empty def as the neg def to do the constractive loss with ori def."}
    )
...
def main():
    ...
    raw_datasets = load_dataset(
        "src/ni_dataset_augment_v2_pos.py", 
        ...
        null_def_cons=training_args.null_def_cons,
    )
    ...
    trainer.init_hyper(pos_neg_ratio=training_args.pos_neg_ratio,margin_pos=training_args.margin_pos,
                       ...
                       null_def_cons=training_args.null_def_cons,neg_loss_only=training_args.neg_loss_only)
