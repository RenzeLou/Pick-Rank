...
from ni_collator_silver_out_test_no_examples import DataCollatorForNI
# from ni_trainer_augment_v2 import NITrainer, DenserEvalCallback
from ni_trainer_argument_output_constrain import NITrainer, DenserEvalCallback
...
from modeling_t5_output_constrain import T5ForConditionalGeneration_neg
...
class DataTrainingArguments:
    ...
    train_add_silver: Optional[bool] = field(
        default=False,
        metadata={"help": "whether to add silver y examples in training set."}
    )
    test_add_silver: Optional[bool] = field(
        default=False,
        metadata={"help": "whether to add silver y examples in test set."}
    )
    test_no_examples: Optional[bool] = field(
        default=False,
        metadata={"help": "whether to add any examples in test set."}
    )
...
def main():
    ...
    raw_datasets = load_dataset(  ## TODO: should be additional "neg_output" attribute in "Instance"
        "src/ni_dataset_silver_out_test_no_example.py", 
        ...
        train_add_silver=data_args.train_add_silver,
        test_add_silver=data_args.test_add_silver,
        test_no_examples=data_args.test_no_examples,
    )
