...
sample_num_list = [1,2,3,4,5,6,7,8]  ## there are 5 kinds of negative instructions  ,2,3,4,5
# margin_list = [0.0001,0.0003,0.0006,0.001,0.003,0.006,0.01,0.03,0.06,0.1,0.3]



## input and output path
exp_name_template = "more-neg_sample-{}"
base_name_template = "{}-pos"
exp_path = "../output"
out_path = "../plot/ratio_margin_fixed_more_neg"
