...
# from ni_collator_augment_v3 import DataCollatorForNI
from ni_trainer_augment_v2 import NITrainer, DenserEvalCallback
# from ni_trainer_augment_v3 import NITrainer, DenserEvalCallback
from compute_metrics import compute_grouped_metrics_add_f, compute_metrics, compute_grouped_metrics, compute_metrics_add_f
from modeling_t5_mod import T5ForConditionalGeneration_neg
...
class NITrainingArguments(Seq2SeqTrainingArguments):
    ...
    margin: float = field(
        default=0.5, metadata={"help": "The margin used in contrastive loss."}
    )
...
def main():
    ...
    # add mix ratio
    trainer.init_hyper(loss_mix_ratio=training_args.loss_mix_ratio,margin=training_args.margin)
