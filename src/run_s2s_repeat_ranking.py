...
from ni_collator_repeat_ranking import DataCollatorForNI
# from ni_trainer_augment_v2 import NITrainer, DenserEvalCallback
from ni_trainer_repeat_ranking import NITrainer, DenserEvalCallback
...
from modeling_t5_repeat_ranking import T5ForConditionalGeneration_neg
...
def main():
    ...
    raw_datasets = load_dataset( 
        "src/ni_dataset_repeat_ranking.py", 
    ...
    data_collator = DataCollatorForNI(
        ...
        add_null=training_args.add_null,
    )
    ...
    trainer.init_hyper(pos_neg_ratio=training_args.pos_neg_ratio,margin_pos=training_args.margin_pos,
                       ...
                       reverse=training_args.reverse,lr_proj=training_args.lr_proj,strategy=training_args.strategy
                       )
