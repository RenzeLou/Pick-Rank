...
class NITrainer(Seq2SeqTrainer):
    ...
    def init_hyper(self,pos_neg_ratio:float,margin_pos:float,margin_neg:float,neg_loss_type:str,loss_mix_ratio:float,
                   sample_num_neg:int,sample_num_pos:int,main_loss_warm:int,null_def_cons:bool,neg_loss_only:bool):
        ...
        self.neg_loss_only = neg_loss_only
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        inputs["neg_loss_only"] = self.neg_loss_only
        if self.null_def_cons:
            # for null def, pos num equal to 0, neg num equal to 1 (i.e., null def)
            inputs["sample_num_pos"] = 0
            inputs["sample_num_neg"] = 1
        
        outputs = model.multiple_forward_batchfy(**inputs)
