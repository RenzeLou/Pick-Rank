...
class NITrainer(Seq2SeqTrainer):
    def init_hyper(self,pos_neg_ratio:float,margin_pos:float,margin_neg:float,margin_null:float,
                   ...
                   reverse:bool,lr_proj:float,lr_encoder:float=1e-5,save_pointer_choice:bool=False, predict_on_rep:bool=False,
                   main_loss_on_rep:bool=False,save_choice_file:str=None,base:bool=False,sample_times:int=1,
                   pointer_train_epoch:int=2,ranking_forbiden_on_pointer:bool=False,prob_save_file:str=None,
                   prob_save_on_rep:bool=False):
            ...
            if has_labels:
                with self.autocast_smart_context_manager():
                    ...
                    if self.prob_save_file is not None:
                        ...
                        # torch.nn.functional.softmax(outputs.logits.detach().cpu(),dim=-1)
                        ...
                        tgt_file = "/home/tuq59834/code/project/Tk-ins/Tk-Instruct/teacher_model/{}.txt".format(self.prob_save_file)
