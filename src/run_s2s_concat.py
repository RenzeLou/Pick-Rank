...
from ni_collator_concat import DataCollatorForNI
# from ni_trainer_augment_v2 import NITrainer, DenserEvalCallback
from ni_trainer_concat import NITrainer, DenserEvalCallback
...
# from modeling_t5_concat import T5ForConditionalGeneration_neg
...
def main():
    ...
    if training_args.diff:
        from modeling_t5_concat_diff import T5ForConditionalGeneration_neg
    else:
        from modeling_t5_concat import T5ForConditionalGeneration_neg
