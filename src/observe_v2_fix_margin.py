...
def print_selection(results:dict,key:str):
    print("\nselect margin based on ratio:{}".format(loss_mix_ratio_list))
    print("===> sorted by {}:".format(key))
    for k,v in results.items():
        print("margin: {}\t{}: {}".format(k,key,v))
...
def main():
    ...
    for sample_num in sample_num_list:
        ...
        for margin in margin_list:
            ...
            plot_neg_exp_EM(all_results,out_path,pic_name="{}_sample_{}_margin_{}_EM".format(model_name,sample_num,margin),plot_tasks=False)
            plot_neg_exp_Rouge(all_results,out_path,pic_name="{}_sample_{}_margin_{}_RougeL".format(model_name,sample_num,margin),plot_tasks=False)
            # print(all_results)
